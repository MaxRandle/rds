...
export const BrandLogoIcon: React.FC<SvgProps> = ({ size, ...props }) => (
  <svg
    width={size}
    height={size}
...
export const BrandLogoIconUpper: React.FC<PathProps> = ({ ...props }) => {
  return (
    <path
      {...props}
...
export const BrandLogoIconLower: React.FC<PathProps> = ({ ...props }) => {
  return (
    <path
      {...props}
