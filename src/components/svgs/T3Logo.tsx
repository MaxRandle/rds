...
type T3LogoProps = React.ComponentPropsWithoutRef<"svg"> & {
  size?: number;
};

export const T3Logo = React.forwardRef<React.ElementRef<"svg">, T3LogoProps>(
  ({ size, ...props }, ref) => {
    return (
      <svg
        ...
        {...props}
      >
        <path d="M165.735 25.0701L188.947 0.972412H0.465994V25.0701H165.735Z" />
        ...
        <path d="M88.2625 192.669L88.2626 45.6459H64.1648L64.1648 192.669H88.2625Z" />
      </svg>
    );
  }
);

T3Logo.displayName = "T3Logo";
