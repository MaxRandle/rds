...
const ReactHookFormLogoVariants = cva([""], { variants: {} });

type ReactHookFormLogoProps = React.ComponentPropsWithoutRef<"svg"> &
  VariantProps<typeof ReactHookFormLogoVariants> & {
    size?: number;
  };

export const ReactHookFormLogo = React.forwardRef<
  React.ElementRef<"svg">,
  ReactHookFormLogoProps
>(({ className, size, ...props }, ref) => {
  const classes = ReactHookFormLogoVariants({});
...
ReactHookFormLogo.displayName = "ReactHookFormLogo";
